...
class unitmanagerprofile extends StatefulWidget {
  const unitmanagerprofile({super.key});

  @override
  State<unitmanagerprofile> createState() => _unitmanagerprofileState();
}

class _unitmanagerprofileState extends State<unitmanagerprofile> {
  String? agentname;
  String? unitname;
  String? jobrole;
  String? userid;
  userlogout? logoutt;
  Future<void> admingout() async {
